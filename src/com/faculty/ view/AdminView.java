...
public class AdminView extends JFrame {
    ...
    private JPanel createGridMenu() {
        ...
        gridPanel.add(createNavCard("Students", "Manage student profiles", e -> openView(new StudentDashboardView())));
        gridPanel.add(createNavCard("Lecturers", "Manage faculty staff", e -> openView(new LecturerDashboardView())));
        gridPanel.add(createNavCard("Courses", "Courses management", e -> openView(new CourseDashboardView())));
        gridPanel.add(createNavCard("Departments", "Academic department management", e -> openView(new DepartmentDashboardView())));
        gridPanel.add(createNavCard("Degrees", "Degree pathways", e -> openView(new DegreeDashboardView())));
