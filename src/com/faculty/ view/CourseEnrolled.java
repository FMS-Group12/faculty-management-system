...
public class CourseEnrolled extends JFrame {
    ...
    private JButton createNavButton(String text) {
        ...
        btn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                if (text.equals("Courses")) btn.setForeground(CLR_ACCENT);
    ...
    private JPanel createTimetablePanel() {
        ...
        JLabel lblTitle = new JLabel("Course Enrolled");
    ...
    private JScrollPane createTable() {
        ...
        Vector<Vector<Object>> data = enrollmentDAO.getEnrollmentsByStudent(currentStudentName);

        DefaultTableModel tableModel = new DefaultTableModel(data, new Vector<>(java.util.Arrays.asList(columns))) {
            @Override
        ...
        // Header and Renderer code stays exactly the same as your previous code
